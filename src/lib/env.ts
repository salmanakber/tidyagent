...
const envSchema = z.object({
  ...
  WIX_VENDOR_PRODUCT_BUSINESS: z.string().optional().default(""),
  WIX_VENDOR_PRODUCT_PRO: z.string().optional().default(""),
  WIX_EMBEDDED_SCRIPT_COMPONENT_ID: z.string().optional().default(""),
  WIX_REVIEWER_EMAIL: z.string().optional().default("wix-reviewer@tidyflowapp.com"),
  WIX_REVIEWER_PASSWORD: z.string().optional().default(""),
