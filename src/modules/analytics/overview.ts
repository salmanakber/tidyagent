...
export async function getDashboardOverview(session: AppSession) {
  ...
  return {
    ...
    agents: agents.map((row) => ({
      ...
      widgetUseGradient: row.widgetUseGradient,
      widgetGradientTo: row.widgetGradientTo,
      widgetGradientAngle: row.widgetGradientAngle,
      widgetTextColor: row.widgetTextColor,
      widgetMessageColor: row.widgetMessageColor,
