  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        description="Operator login, App Market testing, Webflow/Shopify adapters, Webflow card payments, AI keys, Google OAuth, Cloudinary, and voice. Adapter credentials live here — not in .env. Package limits live under Plans."
      />
      <PlatformSettingsForm
        ...
        platformPrices={settings.platformPrices}
